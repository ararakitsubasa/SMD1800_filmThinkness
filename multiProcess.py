...
def mul(ru, b):
  ...
  #  ru = 3
    ...
    data_file = Path("/Users/yaoshunyu/Desktop/programming/SMD1800_filmThinkness-main/SMD1800_filmThinkness-main/histfile.npz")
    ...
    label_file = Path("/Users/yaoshunyu/Desktop/programming/SMD1800_filmThinkness-main/SMD1800_filmThinkness-main/labelfile.npz")
...
def test():
    ...
    with multiprocessing.Pool(PROCESSES) as pool:
        ...
        TASKS = [(mul, (i, 1)) for i in range(10)]
